...
namespace PortMidi
{
	internal class PortMidiMarshal
	{
		...
		[DllImport("portmidi")]
		public static extern void Pt_Sleep(int milliseconds);

		public delegate void PtStartProcDelegate(int milliseconds, IntPtr userData);

		[DllImport("portmidi")]
		public static extern MidiErrorType Pt_Start(int resolution, PtStartProcDelegate callback, IntPtr userData);

		[DllImport("portmidi")]
		public static extern int Pt_Stared();

		[DllImport("portmidi")]
		public static extern MidiErrorType Pt_Stop();
